...
export default function MovingBackground() {
  ...
  useEffect(() => {
    ...
    for (let round of rounds) {
      let element = round.current.getBoundingClientRect();
      round.current.style.opacity = 0.7;
      ...
      <div className="fixed bg-black z-40">
        <div className="fixed">
          <div
            ref={round1}
            id="bgRound1"
            className="bg-[#F3C677] w-48 h-48 rounded-full absolute blur-2xl"
            style={{ opacity: 0, transition: 'opacity 3s ease-in' }}
          ></div>
          <div
            ref={round2}
            id="bgRound2"
            className="bg-[#F9564F] w-[300px] h-[300px] rounded-full absolute blur-2xl"
            style={{ opacity: 0, transition: 'opacity 3s ease-in' }}
          ></div>
          <div
            ref={round3}
            id="bgRound3"
            className="bg-[#3e5368] w-[150px] h-[150px] rounded-full absolute blur-2xl"
            style={{ opacity: 0, transition: 'opacity 3s ease-in' }}
          ></div>
          <div
            ref={round4}
            id="bgRound4"
            className="bg-[#07004D] w-[200px] h-[200px] rounded-full absolute blur-2xl"
            style={{ opacity: 0, transition: 'opacity 3s ease-in' }}
          ></div>
        </div>
      </div>
