  ...
  return (
    <div className="w-full h-auto flex flex-col justify-center items-center gap-28 my-44 md:my-20">
      ...
      {/* <div className="w-full flex justify-center flex-wrap gap-12 items-center my-16">
        ...
        />
        <img
          src={process.env.REACT_APP_LOCAL_IMAGE_PATH + 'google.svg'}
          className="lg:w-auto w-20"
          alt="Right-svg"
        />
        <img
          src={process.env.REACT_APP_LOCAL_IMAGE_PATH + 'amazon.svg'}
          className="lg:w-auto w-20"
          alt="Right-svg"
        />
        <img
          src={process.env.REACT_APP_LOCAL_IMAGE_PATH + 'linkedin.svg'}
          className="lg:w-auto w-20"
          alt="Right-svg"
        />
        <img
          src={process.env.REACT_APP_LOCAL_IMAGE_PATH + 'apple.svg'}
          className="lg:w-auto w-20"
          alt="Right-svg"
        />
      </div> */}
